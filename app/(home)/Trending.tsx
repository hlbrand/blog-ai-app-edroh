    ...
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          ...
          inventore quis voluptates nostrum?
        </p>
      </div>
      ...
      <p className="text-sm">
        ...
        rerum commodi et porro aliquid quas voluptatum maxime neque voluptate
        consequatur, sequi autem. Inventore magni magnam nemo quidem ducimus
        assumenda quaerat?
      </p>
    </section>
  );
